...
const originalCardSpan = `              <span className="text-[10px] font-semibold text-retro-text/60 bg-stone-100 px-2.5 py-0.5 rounded-full flex items-center gap-1.5 shadow-sm">
...
code = code.replace(originalCardSpan, newCardSpan);
