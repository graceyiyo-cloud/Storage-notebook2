...
const pwaShellPlugin = () => ({
  ...
  generateBundle(_: unknown, bundle: Record<string, { fileName: string }>) {
    ...
    const source = `const CACHE='cosmetics-shell-v3';const ASSETS=${JSON.stringify(assets)};
